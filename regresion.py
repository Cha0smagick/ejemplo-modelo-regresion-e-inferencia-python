"""
Pipeline de Análisis de Regresión Científico (Q4 / Polinómico)
...
def main():
    try:
        ...
        # 5. Modelado Q4
        model, y_test_out, y_pred_out, rmse, r2 = pipeline_regresion_q4(X_train, y_train, X_test, y_test)
        
        # 6. Exportación y Diagnóstico
        exportar_modelo(model, "modelo_ecommerce_Q4.pkl")
